...
async def lifespan(app: FastAPI):
    ...
    studio_logger.info("  LOCAL LLM STUDIO (GRAMMAR CORRECTION) — Starting Backend")
...
app = FastAPI(
    title="Local LLM Studio — Grammar Correction & Text Rewriting",
    description="Dual-Mode Local AI Workspace (Ollama Mode + Project Local Model Mode) for Experiment 8",
    version="1.0.0",
    lifespan=lifespan
)
...
async def serve_index():
    ...
    return HTMLResponse("<h1>Local LLM Studio — Grammar Correction</h1><p>Frontend under construction.</p>")
