...
class LocalModelProvider(LLMProvider):
    ...
    async def test_connection(self) -> Dict[str, Any]:
        ...
        try:
            ...
            test_prompt = "Artificial intelligence is a branch of computer science focused on building smart machines capable of performing tasks that typically require human intelligence."
            gen_res = await self.generate(test_prompt, max_tokens=30)
