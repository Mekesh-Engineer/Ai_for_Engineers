...
class StudioSettings:
    """Manages system configuration, active LLM provider modes, and prompt templates."""
    ...
    def __init__(self):
        ...
        self.preferred_local_model_path = str((PROJECT_ROOT / local_cfg.get("preferred_model_path", "./models/saved_models/summarizer_model")).resolve())
        ...
        self.default_system_profile = studio_cfg.get("default_system_profile", "general")
    ...
    def get_profile_prompt(self, profile_key: str) -> str:
        ...
        return profiles.get("general", {}).get("prompt", "You are a helpful local AI assistant.")
